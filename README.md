# timescale_continuous_agg × sqlink bridge (Phase 9.2, timescaledb)

Auto-generated by [`sqlink-shim-codegen`](https://github.com/tegmentum/sqlink-shim-codegen)
via `--dynlink --target timescale_continuous_agg --provider-id timescale_core-composed`.
...
timescale_continuous_agg=$(pwd)/target/wasm32-wasip2/release/timescale_continuous_agg_sqlite_bridge_dynlink.wasm"
...
sqlink -c "LOAD timescale_continuous_agg;"
```
