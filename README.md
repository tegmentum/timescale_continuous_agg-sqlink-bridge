# timescale-continuous-agg-sqlite-bridge-dynlink

Phase A dynlink-mode sqlite bridge for `timescale_continuous_agg` (target `timescale_continuous_agg`).
...
provider `timescale_continuous_agg-composed`. Aggregate / vtab / hook exports are
