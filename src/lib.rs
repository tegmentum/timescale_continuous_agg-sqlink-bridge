...
const PROVIDER_ID: &str = "timescale_continuous_agg-composed";
...
fn scalar_name_by_id(id: u64) -> Option<&'static str> {
    match id {
        1 => Some("add_continuous_aggregate_policy"),
        2 => Some("cagg_get_grouping_columns"),
        3 => Some("refresh_continuous_aggregate"),
        4 => Some("remove_continuous_aggregate_policy"),
        _ => None,
    }
}
...
impl MetadataGuest for Component {
    fn describe() -> Manifest {
        let scalar_functions: Vec<ScalarFunctionSpec> = vec![
            ScalarFunctionSpec {
                id: 1,
                name: "add_continuous_aggregate_policy".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 2,
                name: "cagg_get_grouping_columns".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 3,
                name: "refresh_continuous_aggregate".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 4,
                name: "remove_continuous_aggregate_policy".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
        ];
        let vtabs: Vec<VtabSpec> = vec![
            VtabSpec {
                id: 2000000,
                name: "cagg_get_bucket_function_info".to_string(),
                eponymous: true,
                mutable: false,
                batched: false,
            },
            VtabSpec {
                id: 2000001,
                name: "cagg_validate_query".to_string(),
                eponymous: true,
                mutable: false,
                batched: false,
            },
...
fn vtab_name_by_id(id: u64) -> Option<&'static str> {
    match id {
        2000000 => Some("cagg_get_bucket_function_info"),
        2000001 => Some("cagg_validate_query"),
        _ => None,
    }
}
...
impl VtabGuest for Component {
    ...
    fn connect(
        ...
        match vtab_id {
                2000000 => Ok("CREATE TABLE x(\"result\" BLOB, \"_arg0\" HIDDEN)".to_string()),
